...
def main():
    ...
    exps = read_test("exps/trte_simple/test.cfg",
                     ".cache_io_exps/trte_simple/test",
                     reset=refresh,skip_dne=refresh)
    exps,uuids = cache_io.get_uuids(exps,".cache_io/trte_simple/test",
    ...
    results = cache_io.run_exps(exps,test.run,uuids=uuids,#preset_uuids=True,
                                name=".cache_io/trte_simple/test",
                                version="v1",skip_loop=False,clear_fxn=clear_fxn,
                                clear=False,enable_dispatch="slurm",
                                records_fn=".cache_io_pkl/trte_simple/test.pkl",
                                records_reload=True,to_records_fast=False,
                                use_wandb=True,proj_name="test_simple")
